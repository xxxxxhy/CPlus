...
class Plane {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Point.serialize(obj.normal, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.normal = Point.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.normal !== undefined) {
      resolved.normal = Point.Resolve(msg.normal)
    }
    else {
      resolved.normal = new Point()
    }
