...
"""autogenerated by genpy from control_planner_interface/VehicleExecuteActionGoal.msg. Do not edit."""
import codecs
import sys
...
class VehicleExecuteActionGoal(genpy.Message):
  _md5sum = "33eb81219bc5aedb8e16814cdc4e3857"
  _type = "control_planner_interface/VehicleExecuteActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','control_planner_interface/VehicleExecuteGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VehicleExecuteActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = control_planner_interface.msg.VehicleExecuteGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = control_planner_interface.msg.VehicleExecuteGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.paths)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.paths:
