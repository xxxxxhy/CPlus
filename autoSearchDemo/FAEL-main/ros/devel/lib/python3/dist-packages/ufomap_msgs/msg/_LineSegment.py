...
"""autogenerated by genpy from ufomap_msgs/LineSegment.msg. Do not edit."""
import codecs
import sys
...
class LineSegment(genpy.Message):
  ...
  _type = "ufomap_msgs/LineSegment"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ufomap_msgs/Point start
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.start is None:
        self.start = ufomap_msgs.msg.Point()
      if self.end is None:
        self.end = ufomap_msgs.msg.Point()
    else:
      self.start = ufomap_msgs.msg.Point()
      self.end = ufomap_msgs.msg.Point()
