...
"""autogenerated by genpy from control_planner_interface/ExplorerPlannerActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExplorerPlannerActionResult(genpy.Message):
  _md5sum = "6f8e0c9b9ff746aab230ed6f33da6a1f"
  _type = "control_planner_interface/ExplorerPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','control_planner_interface/ExplorerPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExplorerPlannerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = control_planner_interface.msg.ExplorerPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = control_planner_interface.msg.ExplorerPlannerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.paths)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.paths:
